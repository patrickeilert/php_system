...
<body>
    ...
    <form action="client_update_script.php" method="post">
            ...
            <input type="text" value="<?= $client_name ?>" name="client_name" required><br>
            <input type="text" value="<?= $client_adress ?>" name="address"><br>
            <input type="text" value="<?= $client_contact_name ?>" name="contact_name" required><br>
            <input type="text" value="<?= $client_contact_phone ?>" name="contact_phone" required><br>
